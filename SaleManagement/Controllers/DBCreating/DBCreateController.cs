...
namespace SaleManagement.Controllers.DBCreating
{
    public class DBCreateController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            CustomerHelper_.CreateRandomCustomersToDB();
            ProductHelper_.Init();
            ...
            foreach (var day in days)
            {
                ...
                SaleBillHelper_.NewSaleBill(day);
                ProductHelper_.CreateProductCheckListToDb(day);
            }
    ...
    public static class CustomerHelper_
    {
        ...
        public static void CreateRandomCustomersToDB() //MUST BE CALLED IMMEDIATELY WHEN START Seed().
        {
            ...
            for (int i = 0; i <= 20; i++)
            {
                ...
                customer.StoreID = GlobalHelper_.CURRENT_STORE_ID;

                customer.Gender = isBoy ? true : false;
                customer.BirthDay = DateTime.Now;
                customer.Phone = PhoneHelper_.GetRandomSoDienThoai();
                customer.Email = "example@abc.com";
                customer.Address = "Hà Nội";
                customer.FullName = isBoy ? HumanNameHelper_.GetRandomFullName_Nam() : HumanNameHelper_.GetRandomFullName_Nu();
    ...
    public static class ProductHelper_
    {
        ...
        public static void Init() //Create a product list. NOT inserted to DB yet ! //MUST BE CALLED IMMEDIATELY WHEN START Seed().
        {
            ...
            soulProducts.Add(new Product() { Code = "	SP000025	", Name = "	Mật ong nguyên chất Tây Nguyên	", UnitName = "	Hộp	", RetailPrice = 75000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 71200, DiscountRate = 0, Availability = 10, CategoryName = "	Thực phẩm tự nhiên từ động vật	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/25.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000024	", Name = "	Mật ong rừng nguyên chất	", UnitName = "	Hộp	", RetailPrice = 250000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 237500, DiscountRate = 0, Availability = 18, CategoryName = "	Thực phẩm tự nhiên từ động vật	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/24.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000023	", Name = "	Mật ong Breitsamer 340g	", UnitName = "	Hộp	", RetailPrice = 140000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 133000, DiscountRate = 0, Availability = 12, CategoryName = "	Thực phẩm tự nhiên từ động vật	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/23.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000022	", Name = "	Mật ong Breitsamer 500g	", UnitName = "	Hộp	", RetailPrice = 192500, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 182800, DiscountRate = 0, Availability = 10, CategoryName = "	Thực phẩm tự nhiên từ động vật	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/22.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000021	", Name = "	Mật ong Breitsamer 250g	", UnitName = "	Hộp	", RetailPrice = 105000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 99000, DiscountRate = 0, Availability = 4, CategoryName = "	Thực phẩm tự nhiên từ động vật	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/21.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000020	", Name = "	Yến mạch nguyên chất ăn liền	", UnitName = "	Hộp	", RetailPrice = 102000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 96900, DiscountRate = 0, Availability = 0, CategoryName = "	Ngũ cốc, sản phẩm từ ngũ cốc	", Origin = "	Việt Nam	", BrandName = "	Quế Lân INC	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/20.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000019	", Name = "	Yến mạch nguyên chất Captain Oats	", UnitName = "	Hộp	", RetailPrice = 75000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 71200, DiscountRate = 0, Availability = 4, CategoryName = "	Ngũ cốc, sản phẩm từ ngũ cốc	", Origin = "	Việt Nam	", BrandName = "	Quế Lân INC	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/19.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000018	", Name = "	Yến mạch Captain Oát - Instant Oatmeal 500g	", UnitName = "	Hộp	", RetailPrice = 80000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 76000, DiscountRate = 0, Availability = 4, CategoryName = "	Ngũ cốc, sản phẩm từ ngũ cốc	", Origin = "	Việt Nam	", BrandName = "	Quế Lân INC	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/18.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000017	", Name = "	Ngũ cốc dinh dưỡng canxi	", UnitName = "	Hộp	", RetailPrice = 47000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 44600, DiscountRate = 0, Availability = 8, CategoryName = "	Ngũ cốc, sản phẩm từ ngũ cốc	", Origin = "	Việt Nam	", BrandName = "	Quế Lân INC	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/17.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000016	", Name = "	Yến mạch Captain Oats - Quick Cook 1kg	", UnitName = "	Hộp	", RetailPrice = 150000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 142500, DiscountRate = 0, Availability = 4, CategoryName = "	Ngũ cốc, sản phẩm từ ngũ cốc	", Origin = "	Việt Nam	", BrandName = "	Quế Lân INC	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/16.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000015	", Name = "	Mắt cá Ngừ đại dương	", UnitName = "	Hộp	", RetailPrice = 16000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 15200, DiscountRate = 0, Availability = 6, CategoryName = "	Đặc sản	", Origin = "	Việt Nam	", BrandName = "	Thanh Bình Corp	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/15.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000014	", Name = "	Tré Bình Định	", UnitName = "	Hộp	", RetailPrice = 45000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 42700, DiscountRate = 0, Availability = 8, CategoryName = "	Đặc sản	", Origin = "	Việt Nam	", BrandName = "	Thanh Bình Corp	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/14.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000013	", Name = "	Tỏi Lý Sơn 500gr	", UnitName = "	Hộp	", RetailPrice = 65000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 61700, DiscountRate = 0, Availability = 12, CategoryName = "	Đặc sản	", Origin = "	Việt Nam	", BrandName = "	Thanh Bình Corp	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/13.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000012	", Name = "	Mật ong rừng U Minh 500ml	", UnitName = "	Hộp	", RetailPrice = 190000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 180500, DiscountRate = 0, Availability = 8, CategoryName = "	Đặc sản	", Origin = "	Việt Nam	", BrandName = "	Thanh Bình Corp	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/12.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000011	", Name = "	Miến Dong	", UnitName = "	Hộp	", RetailPrice = 63000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 59800, DiscountRate = 0, Availability = 12, CategoryName = "	Đặc sản	", Origin = "	Việt Nam	", BrandName = "	Thanh Bình Corp	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/11.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000010	", Name = "	Đậu phộng rang Tuệ Giác	", UnitName = "	Hộp	", RetailPrice = 60000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 57000, DiscountRate = 0, Availability = 6, CategoryName = "	Thực phẩm chín, qua chế biến	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/10.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000009	", Name = "	Mực một nắng Thanh Ký	", UnitName = "	Hộp	", RetailPrice = 280000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 266000, DiscountRate = 0, Availability = 8, CategoryName = "	Thực phẩm chín, qua chế biến	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/9.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000008	", Name = "	Heo một nắng Thanh Ký	", UnitName = "	Hộp	", RetailPrice = 139000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 132000, DiscountRate = 0, Availability = 8, CategoryName = "	Thực phẩm chín, qua chế biến	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/8.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000007	", Name = "	Yến Thiên sơ chế 100gr	", UnitName = "	Hộp	", RetailPrice = 2800000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 2660000, DiscountRate = 0, Availability = 2, CategoryName = "	Thực phẩm chín, qua chế biến	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/7.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000006	", Name = "	Chả bò Đà Nẵng	", UnitName = "	Hộp	", RetailPrice = 154000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 146300, DiscountRate = 0, Availability = 2, CategoryName = "	Thực phẩm chín, qua chế biến	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/6.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000005	", Name = "	Cá thu một nắng bịch 500gr	", UnitName = "	Hộp	", RetailPrice = 195000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 185250, DiscountRate = 0, Availability = 8, CategoryName = "	Thực phẩm tươi sống	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/5.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000004	", Name = "	Nấm mối làm sẵn bịch 500gr	", UnitName = "	Hộp	", RetailPrice = 145000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 137750, DiscountRate = 0, Availability = 10, CategoryName = "	Thực phẩm tươi sống	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/4.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000003	", Name = "	Tôm sú tươi sống	", UnitName = "	Hộp	", RetailPrice = 200000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 190000, DiscountRate = 0, Availability = 6, CategoryName = "	Thực phẩm tươi sống	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/3.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000002	", Name = "	Phi lê cá Ngừ đại dương	", UnitName = "	Hộp	", RetailPrice = 230000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 218500, DiscountRate = 0, Availability = 4, CategoryName = "	Thực phẩm tươi sống	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/2.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
            soulProducts.Add(new Product() { Code = "	SP000001	", Name = "	Cá mặt quỷ	", UnitName = "	Hộp	", RetailPrice = 650000, WholesalePrice = 100000, WholesaleMinAmount = 9999999, AverageCost = 617500, DiscountRate = 0, Availability = 10, CategoryName = "	Thực phẩm tươi sống	", Origin = "	Việt Nam	", BrandName = "	Thảo Thảo Pharm	", DateCreated = DateTime.Now, Image = "	/Content/product_images/food/1.jpg	", Description = "	Nội dung mô tả …	", Status = 0, StoreID = GlobalHelper_.CURRENT_STORE_ID });
        ...
        public static void CreateProductCheckListToDb(DateTime date)
        {
            IQueryable<Product> allCurrentProducts = GlobalHelper_.context.Product;
            List<ProductAvailabilityCheck> productAvailabilityCheckList = new List<ProductAvailabilityCheck>();

            foreach(var product in allCurrentProducts)
            {
                productAvailabilityCheckList.Add(new ProductAvailabilityCheck()
                {
                    Date = date,
                    ProductID = product.ID,
                    AmountExpected = product.Availability,
                    AmountChecked = product.Availability,
                    Checked = true,
                });
            }

            GlobalHelper_.context.ProductAvailabilityCheck.AddRange(productAvailabilityCheckList);
            GlobalHelper_.context.SaveChanges();
        }
    }
    ...
    public static class ImportBillHelper_
    {
        public static void NewImport(DateTime date)
        {
            ...
            foreach (var randomProduct in randomProductsInDB) //VỚI MỖI SẢN PHẨM ĐÃ ĐƯỢC LẤY NGẪU NHIÊN TỪ DB.
            {
                ...
                bool imported = false;
                //for (int j = 0; j < importBill.ImportBillDetails.Count; j++)
                foreach (var importBillDetail in importBill.ImportBillDetails)
                    if (randomProduct.ID == importBillDetail.ProductID)
                    {
                ...
                {
                    int importedAmount = GlobalHelper_.randomizer.Next(15) + 1;
                    //RUN LATER : randomProduct.Availability += importedAmount;

                    ImportBillDetail importBillDetail = new ImportBillDetail();
                    importBillDetail.ProductID = randomProduct.ID; //DEBUG HERE ! I EXPECT ID IS GET FROM DB. BUT IT CAN BE NULL IF IM WRONG.
                    importBillDetail.Amount = importedAmount;
                    importBillDetail.Price = Convert.ToInt32(randomProduct.AverageCost.CostFluctuated()); //Average Cost khi áp dụng lên 1 sản phẩm nhập, thì là giá nhập.
            ...
            importBill.Code = "HDN0000" + importBill.ID.ToString();
    ...
    public static class SaleBillHelper_
    {
        public static void NewSaleBill(DateTime date)
        {
            ...
            foreach (var saleBillDetail in saleBill.SaleBillDetails)
            {
                ...
                //DEPRICATED:productToUpdate.AmountSold += saleBillDetail.Amount;
                GlobalHelper_.context.Product.AddOrUpdate(m => m.ID, productToUpdate);
                GlobalHelper_.context.SaveChanges();
            }
            #endregion
